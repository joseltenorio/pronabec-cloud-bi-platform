...
def test_deploy_bigquery_includes_ml_sql_rendered_artifacts():
    ...
    assert "create_region_cluster_model.rendered.sql" in content
    assert "create_region_cluster_assignments.rendered.sql" in content
    ...
    assert content.index("create_region_priority_scores_v2.rendered.sql") < content.index("create_region_cluster_model.rendered.sql")
    assert content.index("create_region_cluster_model.rendered.sql") < content.index("create_region_cluster_assignments.rendered.sql")
...
def test_render_sql_templates_script_passes_ml_dataset_to_renderer():
    ...
    assert "sql/ml/create_region_cluster_model.sql" in content
    assert "sql/ml/create_region_cluster_assignments.sql" in content

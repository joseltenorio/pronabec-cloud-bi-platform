...
SELECT
  ...
  CAST(NULL AS NUMERIC) AS regional_becarios_pct,
  CAST(NULL AS NUMERIC) AS regional_becarios_estimated,
  CAST(NULL AS NUMERIC) AS total_becas_anual,
  CAST(NULL AS NUMERIC) AS becas_por_1000_jovenes,
  CAST(NULL AS NUMERIC) AS becas_por_1000_matriculados_5to,
  CAST(NULL AS NUMERIC) AS demanda_no_cubierta_estimada,
